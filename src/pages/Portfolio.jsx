...
const Portfolio = () => {
  ...
  {/* ---------------- cross button */}
          ...
          {/* ------------ common-portfolio */}
                 <PortfolioCommon portH2={'Landing page (single page website)'} portLink='/https://github.com/antor94/silicon3.git' portSrc='/public/Video/portfolio1.mp4' /> 
                 <PortfolioCommon portH2={'Landing page (single page website)'} portLink='/https://github.com/antor94/silicon3.git' portSrc='/public/Video/portfolio1.mp4' /> 
                 <PortfolioCommon portH2={'Landing page (single page website)'} portLink='/https://github.com/antor94/silicon3.git' portSrc='/public/Video/portfolio1.mp4' /> 
                 <PortfolioCommon portH2={'Landing page (single page website)'} portLink='/https://github.com/antor94/silicon3.git' portSrc='/public/Video/portfolio1.mp4' /> 
                 <PortfolioCommon portH2={'Landing page (single page website)'} portLink='/https://github.com/antor94/silicon3.git' portSrc='/public/Video/portfolio1.mp4' /> 
        ...
        <div className="flex justify-center ">
          <Link  to="/" className="w-60 px-4 py-4 mt-[30px] flex justify-center bg-[#FD6F00] text-base font-semibold font-main text-white hover:bg-[#A53DFF] rounded-lg transition-colors" >  More Projects  </Link>
        </div>
      </div>
    </section>
  );
